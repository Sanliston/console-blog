...
const LandingHero = (): JSX.Element => {
    ...
    return (
        ...
        <div 
            className='absolute lg:top-[100vh] w-full min-h-[2300px] h-auto landing-hero pb-15 mb-15 bg-cover grid grid-cols-1 lg:grid-cols-6 gap-1'

            >

                <div className='container  mx-auto px-0 pt-[200px] col-span-1 lg:col-span-4 lg:col-start-2'>

                    <div className='landing-title flex flex-col items-center justify-center col-span-1 lg:col-span-6 mb-15'>
                    ...
                    <div className='landing-title row-span-2 col-span-1 lg:col-span-6 lg:col-start-1  rounded-lg mx-3'>
                        <div className='flex flex-col h-full items-center justify-center pt-[100px]'>
                            ...
                            {posts.length > 0 ?
                                    ...
                                    <div className='w-full'>
                                        {posts.map((post:any, index:number)=>(
                                            ...
                                            <Link href={`/post/${post.slug}`} key={post.id}>
                                                <div className='flex flex-col md:flex-row justify-items-start items-center w-full mb-4 bg-[#4A5A6A]/[0.3] rounded-lg overflow-hidden cursor-pointer'>

                                                    <img
                                                        className=" w-full md:w-[180px] h-[180px] object-cover md:h-auto md:rounded-none md:mr-5" 
                                ...
                                <div className='flex flex-col items-center justify-center min-h-[1000px] md:min-h-[800px]'> 

                                    <span>
                                        Or you can just jump right in! [Insert button to force scroll here] or even categories etc. 
                                    </span>
                    ...
                    <div className='hidden md:flex flex-col items-center col-span-1 lg:col-span-6 lg:col-start-1 mt-10'>
                        <div className='landing-title bg-[#4A5A6A]/[0.3] rounded-lg mx-3 mt-10'>
                        ...
                        <div className='landing-title lg:col-start-1 bg-[#4A5A6A]/[0.3] rounded-lg mx-3 mt-10'>
                            <div className='flex flex-col items-center justify-center'>
